...
In [distributed systems](/zenoh/), time is a lie.
...
The full mathematical proofs, detailed simulation setup, and complete results are in the paper. If you're building [distributed systems](/zenoh/) that need clock synchronization without external references — particularly in large-scale, dynamic, adversarial, or air-gapped environments — I hope it's useful.

---

## Related

- [Zenoh Protocol Overview](/zenoh/) — The unified communication protocol I designed after this research, spanning microcontroller to cloud with no infrastructure dependencies.
- [Zenoh Research Papers](/zenoh/papers/) — Scientific publications on the Zenoh protocol and distributed systems design.
