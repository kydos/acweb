...
const chapters = [
  ...
  },
  {
    ...
    sections: ["Peer mode", "Client mode", "Router mode", "Multicast scouting", "Regionalisation"],
  },
  {
    num: "05",
    title: "Security",
    desc: "Authentication, encryption, and access control built into the protocol.",
    sections: ["TLS configuration", "Access control lists", "Token-based auth", "Zero-trust extensions"],
  },
  {
    num: "06",
...
export default function ZenohBookPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-16 md:py-24">
      ...
      {/* Read online CTA — coming soon */}
      <div className="mt-8 flex gap-3 flex-wrap animate-fade-in animate-delay-100">
        <span className="btn-primary opacity-60 cursor-not-allowed flex items-center gap-2 w-fit select-none">
          <svg viewBox="0 0 24 24" className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2">
            <path d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
          </svg>
          {t("bookReadOnline")} — Coming Soon
        </span>
        <a
      ...
      <div className="mt-14 animate-fade-in animate-delay-200">
        ...
        <div className="space-y-4">
          {chapters.map((ch) => (
            <div
              key={ch.num}
              className="group rounded-xl border border-stone-200 dark:border-ink-wire bg-white dark:bg-ink-card p-5 hover:border-accent dark:hover:border-accent transition-colors duration-200"
            >
      ...
      <div className="mt-10 border-l-4 border-accent bg-accent/5 dark:bg-accent/10 rounded-r-lg p-5 animate-fade-in animate-delay-300">
        <p className="text-sm text-stone-700 dark:text-fog leading-relaxed">
          The Zenoh Book is being authored and will be published as an{" "}
          <a
